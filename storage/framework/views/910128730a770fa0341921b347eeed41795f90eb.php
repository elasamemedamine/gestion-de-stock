                            ...
                            <div class="col-md-3">
                                <div class="card p-2 mb-2 d-flex
                                    ...
                                    <div class="align-self-end">
                                        <input type="checkbox" name="st_id[]" id="st" value="<?php echo e($st->id); ?>">
                                    </div>
                                            ...
                                            <div class="card-body d-flex
                                                ...
                                                <h5 class="font-weight-bold mt-2">
                                                    <span class="badge badge-danger">
                                                        livreur : <?php echo e($sale->livreur->name); ?>
        ...
        <div class="row justify-content-center mt-2">
            <div class="col-md-12 card p-3">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a href="#<?php echo e($category->slug); ?>" class="nav-link mr-1 <?php echo e($category->slug === "salades-marocaines" ? "active" : ""); ?>" id="<?php echo e($category->slug); ?>-tab" data-toggle="pill" role="tab" aria-controls="<?php echo e($category->slug); ?>" aria-selected="true">
                ...
                <div class="tab-content" id="pills-tabcontent">
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane fade <?php echo e($category->slug === "salades-marocaines" ? "show active" : ""); ?>" id="<?php echo e($category->slug); ?>" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="row">
