                            ...
                            <div class="col-md-3">
                                <div class="card p-2 mb-2 d-flex
                                    ...
                                    <div class="align-self-end">
                                        <input type="checkbox" name="stock_id[]" id="stock" value="{{ $st->id }}">
                                    </div>
                                    ...
                                    <div class="d-flex
                                                    ...
                                                    align-items-center">
                                        <a href="{{ route("stock.edit",$st->slug) }}" class="btn btn-sm btn-warning">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                    </div>
                                    <hr>
                                    @foreach ($st->sales as $sale)
        ...
        <div class="row justify-content-center mt-2">
            <div class="col-md-12 card p-3">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a href="#{{ $category->slug }}" class="nav-link mr-1 {{ $category->slug === "test1" ? "active" : "" }}" id="{{ $category->slug }}-tab" data-toggle="pill" role="tab" aria-controls="{{ $category->slug }}" aria-selected="true">
                            {{ $category->title }}
                        </a>
                    </li>
                    @endforeach
                ...
                <div class="tab-content" id="pills-tabcontent">
                    @foreach ($categories as $category)
                    <div class="tab-pane fade {{ $category->slug === "test1" ? "show active" : "" }}" id="{{ $category->slug }}" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="card h-100">
                                    <div class="card-body d-flex
                                                ...
                                                align-items-center">
                                        <div class="align-self-end">
                                            <input type="checkbox" name="tarif_id[]" id="tarif_id" value="{{ $tarif->id }}">
                                        </div>
